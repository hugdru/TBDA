...
\begin{center}\csvautotabular[respect all]{../c.csv}\end{center}
...
\begin{center}\csvautotabular[respect all]{../d.csv}\end{center}

\section{List the production of each journalist, including statistics}
\lstinputlisting[language=SQL]{../e.sql}
\begin{center}\csvautotabular[respect all]{../e.csv}\end{center}
